	...
	<div class="wrapper">
										...
										<li>
											<!-- start message --> <a href="#">
												<div class="pull-left">
													<!-- User Image -->
													<img
														src="<spring:url value="/ressources/img/user2-160x160.jpg"></spring:url>"
		...
		<aside class="main-sidebar">
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu">
					...
					<li class="active"><a href="#/PrSel" data-toggle="modal"
						data-target="#myModal"><i class="fa fa-link"></i> <span>Projects</span></a></li>
					<li><a href="#"><i class="fa fa-link"></i> <span>Another
								Link</span></a></li>
					<li class="treeview"><a href="#"><i class="fa fa-link"></i>
							<span>Projects</span> <i class="fa fa-angle-left pull-right"></i></a>
						<ul class="treeview-menu">
							<li><a href="#/ProjectList">Active</a></li>
		...
		<div class="content-wrapper" ng-controller="MainController">
			...
			<section class="content-header">
				<!--<jsp:include page="/templates/menus/scroll.jsp" />  -->
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="control-group">
						...
						<div class="controls">
							<label for="date-picker-2" class="control-label"> Start
								Date</label>
